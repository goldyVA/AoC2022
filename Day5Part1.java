...
public class Day5Part1
{
  public static void main(String[] args) 
  {
    ...
    for(String x: list)
    {
    	...
    	{
    		while(temp.size()>0)
    			one.add(temp.remove(0));
    	}
    	else if(finish == 2)
    	{
    		while(temp.size()>0)
    			two.add(temp.remove(0));
    	}
    	else if(finish == 3)
    	{
    		while(temp.size()>0)
    			three.add(temp.remove(0));
    	}
    	else if(finish == 4)
    	{
    		while(temp.size()>0)
    			four.add(temp.remove(0));
    	}
    	else if(finish == 5)
    	{
    		while(temp.size()>0)
    			five.add(temp.remove(0));
    	}
    	else if(finish == 6)
    	{
    		while(temp.size()>0)
    			six.add(temp.remove(0));
    	}
    	else if(finish == 7)
    	{
    		while(temp.size()>0)
    			seven.add(temp.remove(0));
    	}
    	else if(finish == 8)
    	{
    		while(temp.size()>0)
    			eight.add(temp.remove(0));
    	}
    	else if(finish == 9)
    	{
    		while(temp.size()>0)
    			nine.add(temp.remove(0));
    	}	
    } 
